            ...
            <div class="booking-grid mt-6">
                ...
                <div class="picker-panel">
                    ...
                    <div class="mb-4">
                        <Link
                            href="/doctors"
                            class="inline-flex items-center gap-1.5 text-xs font-bold text-[#16301F] transition hover:underline"
                        >
                            <svg
                                viewBox="0 0 24 24"
                                fill="none"
                            ...
                            Browse All Doctors &amp; Specialists
                        </Link>
                    </div>

                    <!-- DOCTOR SWITCHER HEADER -->
                    <div
                        v-if="availableDoctors && availableDoctors.length > 1"
                        class="mb-8 flex flex-col items-start justify-between gap-3 rounded-2xl border border-[#E7E3D3] bg-[#EFEDE4] p-4 sm:flex-row sm:items-center"
                    >
                        <div>
                            <span
                                class="text-xs font-bold tracking-wider text-[#62655A] uppercase"
                                >Select Physician</span
                            >
                            <h3 class="text-base font-extrabold text-[#16301F]">
                                {{ doctor.user.name }}
                            </h3>
                        </div>
                        <select
                            ...
                            class="rounded-xl border border-[#E7E3D3] bg-white px-3 py-2 text-sm font-semibold text-[#16180F] outline-none focus:border-[#16301F]"
                        >
                            <option
                                v-for="doc in availableDoctors"
                                :key="doc.id"
                                :value="doc.license_number"
                            >
                    ...
                    <div class="calendar-box">
                        ...
                        <div class="dates-grid">
                            <button
                                ...
                                class="date-btn"
                                :class="{
                                    active: selectedDate === item.dateStr,
                                }"
