    ...
    <div class="welcome-banner">
        <template v-if="nextAppointment">
            <div class="welcome-text">
                ...
                <p>
                    {{ nextAppointment.date_formatted }} at
                    {{ nextAppointment.time_formatted }} ·
        ...
        <template v-else>
            <div class="welcome-text">
                ...
                <p>
                    Book an appointment with top specialists across Cardiology,
    ...
    <div class="metrics-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-icon icon-green">
                ...
                >
                    <path
                        d="M10.5 20.4l-6.9-6.9c-.8-.8-.8-2 0-2.8l11.3-11.3c.8-.8 2-.8 2.8 0l6.9 6.9c.8.8.8 2 0 2.8l-11.3 11.3c-.8.8-2 .8-2.8 0z"
                    />
                </svg>
            </div>
        </div>
    ...
    <div class="dashboard-grid">
        ...
        <div class="card-shell">
            <div class="card-header">
                ...
                <Link href="/patient/appointments" class="header-link"
                    >View all</Link
                >
            </div>
                        ...
                        <tr v-for="app in upcomingAppointments" :key="app.id">
                            ...
                            <td>
                                <div class="action-menu">
                                    ...
                                    >
                                    <Link
                                        :href="`/patient/appointments/${app.id}/reschedule`"
        ...
        <div class="side-column">
            ...
            <div class="card-shell">
                <div class="card-header">
                    ...
                    <Link href="/patient/notifications" class="header-link"
                        >View all</Link
                    >
                </div>
                <div class="feed-list">
...
.btn-table-action.text-muted {
    color: var(--ink-muted);
}
.btn-table-action.primary-btn {
    background: var(--forest);
    color: #fff;
    border-color: var(--forest);
}
.btn-table-action.primary-btn:hover {
