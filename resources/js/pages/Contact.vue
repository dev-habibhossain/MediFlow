    ...
    <PublicLayout>
        <div class="wrap py-12">
            ...
            <section class="page-hero mb-12">
                ...
                <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight mb-4">Contact MediFlow Desk</h1>
                <p class="text-lg text-[#62655A] max-w-2xl">Have questions about our specialists, appointments, or medical services? Send us a message or call our desk directly.</p>
            </section>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
                ...
                <div class="space-y-6">
                    <div class="bg-white border border-[#E7E3D3] rounded-2xl p-7 shadow-card">
                        ...
                        <h4 class="font-bold text-base mb-1">Phone Assistance</h4>
                        <p class="text-sm font-semibold text-[#16301F] mb-1">{{ contactDetails.phone }}</p>
                    ...
                    <div class="bg-white border border-[#E7E3D3] rounded-2xl p-7 shadow-card">
                        ...
                        <h4 class="font-bold text-base mb-1">Email Support</h4>
                        <p class="text-sm font-semibold text-[#16301F]">{{ contactDetails.email }}</p>
                    </div>
                    ...
                    <div class="bg-white border border-[#E7E3D3] rounded-2xl p-7 shadow-card">
                        ...
                        <h4 class="font-bold text-base mb-1">Hospital Location</h4>
                ...
                <div class="lg:col-span-2 bg-white border border-[#E7E3D3] rounded-3xl p-8 md:p-10 shadow-card">
                    ...
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        <button type="submit" :disabled="form.processing" class="w-full md:w-auto px-8 py-3.5 rounded-full bg-[#16301F] text-white hover:bg-[#1E4029] font-semibold text-sm transition-colors disabled:opacity-50">
