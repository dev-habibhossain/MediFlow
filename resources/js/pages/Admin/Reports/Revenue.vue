    ...
    <div class="metrics-grid mb-6">
        ...
        <div class="metric-card">
            <div class="metric-meta">
                ...
                <b>$28,400</b>
                <small>64 Claims Processed</small>
            </div>
    ...
    <div class="card-shell">
        <div class="table-responsive">
            <table class="data-table">
                ...
                <tbody>
                    <tr>
                        <td style="font-family: var(--font-mono); font-weight: 700;">#INV-89201</td>
                        <td><b>Habib Hossain</b></td>
                        <td>Cardiology Consultation (#MDF-101)</td>
                        <td style="font-family: var(--font-mono); font-weight: 700;">$120.00</td>
                        <td style="font-family: var(--font-mono); font-size: 12.5px;">Aug 7, 2026</td>
                        <td><span class="status-badge status-paid">Paid (Stripe)</span></td>
                    </tr>
                    <tr>
                        <td style="font-family: var(--font-mono); font-weight: 700;">#INV-89198</td>
                        <td><b>Tanjila Ahmed</b></td>
                        <td>Neurology Consultation (#MDF-102)</td>
                        <td style="font-family: var(--font-mono); font-weight: 700;">$140.00</td>
                        <td style="font-family: var(--font-mono); font-size: 12.5px;">Aug 7, 2026</td>
                        <td><span class="status-badge status-paid">Paid (Stripe)</span></td>
                    </tr>
                    <tr>
                        <td style="font-family: var(--font-mono); font-weight: 700;">#INV-89150</td>
                        <td><b>Robert Fox</b></td>
                        <td>Pediatrics Consultation (#MDF-881)</td>
                        <td style="font-family: var(--font-mono); font-weight: 700;">$110.00</td>
                        <td style="font-family: var(--font-mono); font-size: 12.5px;">July 14, 2026</td>
                        <td><span class="status-badge status-paid">Paid (Insurance)</span></td>
                    </tr>
                </tbody>
            </table>
        </div>
