...
<template>
    <Head title="Announcements & Broadcasts — Admin Portal" />
    ...
    <div class="card-shell mb-6">
        ...
        <form @submit.prevent="handlePublish">
            <div class="form-group">
                ...
                <input id="annTitle" v-model="title" type="text" class="form-control" required placeholder="e.g. Holiday Hours & Emergency Scheduling Notice" />
            </div>

            <div class="form-group">
                <label for="annTarget">Target Audience</label>
                <select id="annTarget" v-model="target" class="form-control" required>
            ...
            <div class="form-group">
                <label for="annContent">Message Body</label>
                <textarea id="annContent" v-model="content" class="form-control" required placeholder="Write broadcast message details here..."></textarea>
            </div>
