...
const bigLineChartOptions: ChartOptions<'line'> = {
    responsive: true,
    ...
    plugins: {
        ...
        tooltip: {
            ...
            callbacks: {
                label: (context: any) =>
                    ` Total Visits: ${context.parsed.y} consultations`,
            },
        },
    },
    scales: {
        ...
        y: {
            ...
            ticks: {
                color: '#94A3B8',
                font: { family: 'Courier, monospace', size: 11 },
            },
        },
    },
};
...
const mediumPillarChartOptions: ChartOptions<'bar'> = {
    responsive: true,
    maintainAspectRatio: false,
    plugins: {
        legend: { display: false },
    ...
    scales: {
        ...
        y: {
            ...
            ticks: {
                color: '#94A3B8',
                font: { family: 'Courier, monospace', size: 10 },
            },
        },
    },
};
...
const smallCircleChartOptions: ChartOptions<'doughnut'> = {
    responsive: true,
    maintainAspectRatio: false,
    plugins: {
        legend: {
...
<template>
    ...
    <div class="dash-header mb-6">
        <div>
            ...
            <p class="page-subtitle">
                Hospital operational metrics for
                {{ props.systemConfig.hospital_name }}
            </p>
        </div>
    ...
    <div class="kpi-grid mb-8">
        ...
        <div class="kpi-card accent-green">
            ...
            <b class="kpi-val">{{
                props.stats.total_doctors.toLocaleString()
            }}</b>
            <div class="kpi-foot">
                <span class="trend trend-green font-mono"
                    >↑ +{{ props.stats.doctors_this_month }}</span
                >
        ...
        <div class="kpi-card accent-sky">
            ...
            <b class="kpi-val">{{
                props.stats.active_patients.toLocaleString()
            }}</b>
            <div class="kpi-foot">
                <span class="trend trend-sky font-mono"
                    >↑ +{{ props.stats.patients_this_month }}</span
                >
        ...
        <div class="kpi-card accent-amber">
            ...
            <b class="kpi-val">{{
                props.stats.appointments_today.toLocaleString()
            }}</b>
            <div class="kpi-foot">
                <span class="trend trend-amber font-mono"
                    >{{ props.stats.completed_today }} Done</span
                >
                <span class="kpi-desc"
                    >{{ props.stats.pending_today }} Pending</span
                >
            </div>
        </div>
        ...
        <div class="card-head-flex">
            <div>
                <h3 class="chart-title">
                    Clinical Consultation Volume & Growth
                </h3>
                <p class="chart-sub">
                    6-Month trailing trend curve of completed patient visits
                </p>
            </div>
        ...
        <div class="analytics-card medium-card">
            <div class="card-head-flex">
                <div>
                    ...
                    <p class="chart-sub">
                        Comparative monthly visit distribution & peak capacity
                    </p>
                </div>
            ...
            <div class="medium-chart-box">
                <Bar
                    :data="mediumPillarChartData"
                    :options="mediumPillarChartOptions"
                />
            </div>
        </div>
        ...
        <div class="analytics-card small-circle-card">
            <div class="card-head-flex">
                <div>
                    ...
                    <p class="chart-sub">
                        Breakdown of patient consultations by medical department
                    </p>
                </div>
            ...
            <div class="small-chart-box">
                <Doughnut
                    :data="smallCircleChartData"
                    :options="smallCircleChartOptions"
                />
            </div>
        </div>
    </div>
            ...
            <div class="content-card mb-6">
                <div class="card-head-flex">
                    <div>
                        ...
                        <p class="section-sub">
                            Incoming patient appointment roster
                        </p>
                    </div>
                    <Link href="/admin/patients" class="header-link"
                ...
                <div class="table-wrap">
                    <table class="clean-table">
                        ...
                        <tbody>
                            <tr
                                v-for="app in props.recentAppointments || []"
                                :key="app.id"
                            >
                                <td>
                                    <div class="patient-cell">
                                        <img
                                            v-if="app.patient_avatar"
                                            :src="app.patient_avatar"
                                            :alt="app.patient_name"
                                            class="p-img"
                                        />
                                        <div v-else class="p-init">
                                            {{ app.patient_initials }}
                                        </div>
                                        <div>
                                            <b class="p-name">{{
                                                app.patient_name
                                            }}</b>
                                            <span class="p-code font-mono"
                                                >#{{ app.code }}</span
                                            >
                                        </div>
                                    </div>
                            ...
                            <tr
                                v-if="
                                    !props.recentAppointments ||
                                    props.recentAppointments.length === 0
                                "
                            >
                                <td
                                    colspan="6"
        ...
        <div class="data-col-right">
            ...
            <div class="content-card mb-6">
                <div class="card-head-flex">
                    ...
                    <Link href="/admin/doctors" class="header-link"
                        >All Doctors →</Link
                    >
                </div>
                ...
                <div class="doctors-list">
                    <div
                        v-for="doc in props.doctorsRoster || []"
                        :key="doc.id"
                        class="doc-row"
                    >
            ...
            <div class="content-card">
                ...
                <div class="dept-list">
                    <div
                        v-for="dept in props.departmentDistribution || []"
                        :key="dept.id"
                        class="dept-item"
                    >
                        <div class="dept-head">
                            <span class="dept-name">{{ dept.name }}</span>
                            <span class="dept-pct font-mono"
...
.kpi-card:hover {
    ...
    box-shadow: 0 10px 28px rgba(11, 37, 28, 0.08);
}
...
.highlight-bg {
    background: linear-gradient(180deg, #f7fcf7 0%, var(--card) 100%);
}
